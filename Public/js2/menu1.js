...
function MN_Exit(){
	...
	document.write('<td height="20" valign="bottom" class="border"><table  cellpadding="0" cellspacing="0"><tr><td width="16"></td><td ><img src="images/tuichu.gif" width="13" height="13">&nbsp;ÍË&nbsp;&nbsp;³ö</td></table></td>');
	document.write('</tr>');
	document.write('<tr>');
